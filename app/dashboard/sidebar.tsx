...
const FINANCE_NAV = [
  {
    ...
    icon: <Icon d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />,
  },
  {
    label: 'Paystack',
...
const PARTNERS_NAV = [
  ...
  },
  {
    ...
    icon: <Icon d="M2.25 12 10.204 4.045a1.125 1.125 0 0 1 1.591 0L19.75 12M4.5 9.75v9.375c0 .621.504 1.125 1.125 1.125H9v-4.875c0-.621.504-1.125 1.125-1.125h1.75c.621 0 1.125.504 1.125 1.125v4.875h3.375c.621 0 1.125-.504 1.125-1.125V9.75" />,
  },
] as const
...
const ADMIN_NAV = [
  ...
  },
  {
    ...
    icon: <Icon d="M9.348 14.651a3.75 3.75 0 0 0 5.304 0l5.25-5.25a3.75 3.75 0 0 0-5.304-5.303l-.75.75m-3.696 14.304-.75.75a3.75 3.75 0 0 1-5.304-5.304l5.25-5.25a3.75 3.75 0 0 1 5.304 0" />,
  },
  {
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-slate-200 px-3 py-2 pr-10 text-sm text-slate-900 placeholder:text-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                placeholder="••••••••"
                autoComplete="current-password"
              />
              <button
                type="button"
                onClick={() => setShowCurrentPw((visible) => !visible)}
                className="absolute inset-y-0 right-0 flex w-10 items-center justify-center text-slate-400 transition-colors hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-indigo-500"
                aria-label={showCurrentPw ? 'Hide current password' : 'Show current password'}
              >
                <PasswordVisibilityIcon visible={showCurrentPw} />
              </button>
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              ...
              >
                <PasswordVisibilityIcon visible={showNewPw} />
              </button>
            </div>
          </div>
