        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6">
          ...
          <div>
            ...
            <p className="mt-2.5 text-xs text-slate-400">
              Sending to: <span className="font-semibold text-slate-600">{audienceLabel}</span> via FCM push
            </p>
          </div>
              ...
              <div className="mt-5 rounded-2xl bg-white/95 backdrop-blur p-3 shadow-lg">
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm font-bold text-slate-900 leading-snug wrap-break-word">{title || 'Notification title'}</p>
                    <p className="text-xs text-slate-600 leading-snug wrap-break-word mt-0.5">{body || 'Your message preview appears here.'}</p>
                  </div>
                </div>
              </div>
            </div>
