...
export async function getVehicleTypes(): Promise<VehicleType[]> {
  try {
    const result = await apiFetch<unknown>("/api/v1/vehicle-types/admin", {
      token: await token(),
    });
...
export async function updateVehicleType(
  ...
  try {
    const data = await apiFetch<VehicleType>(
      `/api/v1/vehicle-types/admin/${id}`,
      {
        method: "PATCH",
        body: JSON.stringify(payload),
        token: await token(),
...
export async function getVehicleBrands(): Promise<VehicleBrand[]> {
  try {
    const result = await apiFetch<unknown>("/api/v1/vehicle-brands/admin", {
      token: await token(),
    });
  ...
  try {
    ...
    return {
      error:
        err instanceof ApiError
          ? err.message
          : "Failed to create vehicle brand.",
    };
  }
}
...
export async function updateVehicleBrand(
  ...
  try {
    const data = await apiFetch<VehicleBrand>(
      `/api/v1/vehicle-brands/admin/${id}`,
      {
        method: "PATCH",
        body: JSON.stringify(payload),
        token: await token(),
    ...
    return {
      error:
        err instanceof ApiError
          ? err.message
          : "Failed to update vehicle brand.",
    };
  }
}
  ...
  try {
    ...
    return {
      error:
        err instanceof ApiError
          ? err.message
          : "Failed to delete vehicle brand.",
    };
  }
}
...
export async function getStoreTypes(): Promise<StoreType[]> {
  try {
    const result = await apiFetch<unknown>("/api/v1/store-types/admin", {
      token: await token(),
    });
...
export async function createStoreType(
  ...
  try {
    ...
    return {
      error:
        err instanceof ApiError ? err.message : "Failed to create store type.",
    };
  }
}
...
export async function updateStoreType(
  ...
  try {
    ...
    return {
      error:
        err instanceof ApiError ? err.message : "Failed to update store type.",
    };
  }
}
...
export async function deleteStoreType(id: string): Promise<{ error?: string }> {
  try {
    ...
    return {
      error:
        err instanceof ApiError ? err.message : "Failed to delete store type.",
    };
  }
}
...
export async function getCuisines(): Promise<Cuisine[]> {
  try {
    const result = await apiFetch<unknown>("/api/v1/cuisines/admin", {
      token: await token(),
    });
...
export async function createCuisine(
  ...
  try {
    ...
    return {
      error:
        err instanceof ApiError ? err.message : "Failed to create cuisine.",
    };
  }
}
...
export async function updateCuisine(
  ...
  try {
    ...
    return {
      error:
        err instanceof ApiError ? err.message : "Failed to update cuisine.",
    };
  }
}
...
export async function deleteCuisine(id: string): Promise<{ error?: string }> {
  try {
    ...
    return {
      error:
        err instanceof ApiError ? err.message : "Failed to delete cuisine.",
    };
  }
}
...
export async function getCategories(): Promise<Category[]> {
  try {
    const result = await apiFetch<unknown>(
      "/api/v1/categories?page=1&limit=100",
      {
        token: await token(),
      },
    );
